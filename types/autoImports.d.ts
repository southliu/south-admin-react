...
declare global {
  ...
  const LoadingComponent: typeof import('../src/components/Form/components/LoadingComponent').default
  ...
  const TIME_PICKER_FORMAT: typeof import('../src/utils/config').TIME_PICKER_FORMAT
...
declare global {
  // @ts-ignore
  export type { FC, BusinessComponents, RangeValue, SearchModalProps, Langs, ApiSelectProps, ApiTreeSelectProps, ApiPageSelectProps, CheckboxList, InitTableState, TableAction, EditorProps, ThemeType, TabsData } from './autoImports.d'
  ...
  import('./form')
  // @ts-ignore
  export type { ArrayData, EmptyData, PageServerResult, PaginationData, SideMenu, PagePermission, EnumShowType, ColumnsEnum, TableColumn, BaseTableProps, TableOptions } from './public'
  import('./public')
}
